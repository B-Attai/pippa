...
export default function SkinAssessment(props) {
    ...
    const [sensoryPerception, setSensoryPerception] = React.useState();
    const [moisture, setMoisture] = React.useState();
    const [mobility, setMobility] = React.useState();
    const [nutrition, setNutrition] = React.useState();
    const [frictionShear, setFrictionShear] = React.useState();
    ...
    function handleSubmit(e) {
        ...
        if ((!sensoryPerception) || (isNaN(sensoryPerception))) {
        ...
        else if ((!frictionShear) || (isNaN(frictionShear))) {
            ...
            const sendSkinData = {
                ...
                frictionShear: parseInt(frictionShear),
